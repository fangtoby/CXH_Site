...
extension UIColor{
    ...
    class func viewBackgroundColor() ->UIColor{
        return UIColor(red: 237/255, green:242/255, blue:245/255, alpha: 1)
    }
    class func color333() -> UIColor{
        return UIColor.RGBFromHexColor("#333333")
    }
    class func color666() -> UIColor{
        return UIColor.RGBFromHexColor("#666666")
    }
    class func color999() -> UIColor{
        return UIColor.RGBFromHexColor("#999999")
    }
    //文字颜色
