...
import UIKit
/// 揽件详情
class CourierDetailsViewController:BaseViewController{
    ...
    override func viewDidLoad() {
        ...
        if expressmailId != nil{
            queryExpressmailDetail()
        }else{
...
//    }
    ...
    func queryExpressmailDetail(){
        PHMoyaHttp.sharedInstance.requestDataWithTargetJSON(RequestAPI.queryExpressmailDetail(expressmailId: entity!.expressmailId!), successClosure: { (result) -> Void in
...
// MARK: - table协议
extension CourierDetailsViewController:UITableViewDelegate,UITableViewDataSource{
...
// MARK: - 实现协议
extension CourierDetailsViewController:UICollectionViewDelegate,UICollectionViewDataSource{
