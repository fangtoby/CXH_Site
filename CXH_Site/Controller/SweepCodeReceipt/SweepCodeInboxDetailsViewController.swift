//
//  SweepCodeInboxDetailsViewController.swift
//  CXH_Site
//
...
import UIKit
/// 扫码收件详情
class SweepCodeInboxDetailsViewController:BaseViewController{
    //接收收件详情
...
// MARK: - table协议
extension SweepCodeInboxDetailsViewController:UITableViewDelegate,UITableViewDataSource{
